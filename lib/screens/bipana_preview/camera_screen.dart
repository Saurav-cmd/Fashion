              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: IconButton(
                      onPressed:(){},
                      tooltip: 'Pick Image',icon:Icon(Icons.camera_alt_outlined,color:ChooseColor(0).appBarColor1,),
                    ),
                  ),
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      child:Text('Submit',maxLines: 1,style: TextStyle(fontSize:size.height*0.014+size.width*0.014),),
                      onPressed: (){
