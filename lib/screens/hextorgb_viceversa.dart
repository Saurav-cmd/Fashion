...
class HexToRgbConverter extends StatefulWidget {
  @override
  _HexToRgbConverter createState() => _HexToRgbConverter();
}

class _HexToRgbConverter extends State<HexToRgbConverter> {
  var h = 0xff000;
  var r = 0, g = 0, b = 0;
  ...
  var txt = TextEditingController(),
      rc = TextEditingController(text: '0'),
      bc = TextEditingController(text: '0'),
      gc = TextEditingController(text: '0');
  bool v = true;
  @override
  Widget build(BuildContext cxt) {
    OutlineInputBorder o = const OutlineInputBorder(
      ...
      child: Container(
        ...
        child: Center(
          child: TextField(
            ...
            style: TextStyle(
                color: wht, fontSize: 20, fontWeight: FontWeight.bold),
            onChanged: (t) {
              setState(() {
                try {
                  if (int.parse(t) > 255) {
