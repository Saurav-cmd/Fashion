...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        noticeimage: List<Noticeimage>.from(
            json["noticeimage"].map((x) => Noticeimage.fromJson(x))),
        tintnoticeimage: List<Noticeimage>.from(
            json["tintnoticeimage"].map((x) => Noticeimage.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "tintnoticeimage":
            List<dynamic>.from(tintnoticeimage!.map((x) => x.toJson())),
      };
}
